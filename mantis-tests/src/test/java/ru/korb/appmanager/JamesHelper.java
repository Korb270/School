...
public class JamesHelper {
    ...
    private void initTelnetSession() {
        mailserver = String.valueOf(app.getProperty("mailserver.host"));
    ...
    private List<MailMessage> getAllMail(String username, String password) throws javax.mail.MessagingException {
        Folder inbox = openInbox(username, password);
    ...
    private static MailMessage toModelMail(Message m) {
        try {
            return new ru.korb.model.MailMessage(m.getAllRecipients()[0].toString(), (String) m.getContent());
